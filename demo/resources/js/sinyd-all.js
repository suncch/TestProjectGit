var global_param = {
		context_name: '/lyram',
		tab_number: 10, // 不控制显示标签数
        tab_limit_tip: true, // 标志标签提示是否已经给出，如果没有给出那么当标签数量超过指定数量的时候则给予提示，如已经提示过了那么直接自动关闭最早打开的标签
        tab_limit_tip_content: '主页默认最多同时打开10个标签页，请您关闭不用的标签页后再打开新页，默认会关闭最早打开的标签页，此提示不再出现。', // 关闭标签提示
        layout_bottomHeight:-4, //标志主页面上最下面面板的高度
        layout_leftWidth: 228, //标志主页面上左侧菜单面板的宽度
		...
		upload_file_url: 'http://127.0.0.1:8080/upload'
};
...
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/error.message.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/global.ligerui.extend.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/global.util.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/page.init.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/accordion.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/tab.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/sydjs/form.js"></script>');

document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/chart/highstock.js"></script>');
document.write('<script language="Javascript" src="'+global_param.context_name+'/resources/js/chart/highcharts-more.js"></script>');
