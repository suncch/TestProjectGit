    <%@page import="java.io.File"%>
        ...
        <%@ page import="com.sinyd.lnram.util.Uploader" %>
    ...
    String[] fileType = {".gif" , ".png" , ".jpg" , ".jpeg" , ".bmp", ".rar" , ".doc" , ".docx" , ".zip" , ".pdf" , ".txt" , ".swf", ".wmv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4"};  //允许的文件类型
