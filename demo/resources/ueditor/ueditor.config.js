...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		,imagePath : "http://192.168.1.214:9089/famUpload/" // 图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
//		,imagePath:"http://192.168.1.167:8080/famUpload/" 	// //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
		// ,imageFieldName:"upfile" //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
		,compressSide : 0 // 等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
		,maxImageSideLength : 350 // 上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
		// ,savePath: [ '图片', '文件', '其他' ] //图片保存在服务器端的目录， 默认为空， // 此时在上传图片时会向服务器请求保存图片的目录列表，
		,savePath : [ 'Image', 'File', 'Other' ] // 图片保存在服务器端的目录， 默认为空， // 此时在上传图片时会向服务器请求保存图片的目录列表，
		...
		,filePath : "http://192.168.1.214:9089/famUpload/" // URL + "jsp/" // //附件修正地址，同imagePath
//		,filePath:"http://192.168.1.167:8080/famUpload/" //URL + "jsp/"
		// //附件修正地址，同imagePath
