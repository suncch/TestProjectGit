package com.sinyd.sframe.util.ui;
...
public class GridModify {
	 ...
	 * */
	public static void modifyRow(GridDataBean grid, String bgColor,
			boolean isBolt, String fontColor, IGridRowCondition condition) {
